...
export async function POST(req: Request) {
  try {
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #030611; color: #f3f4f6; padding: 40px 16px;">
          <div style="max-width: 680px; margin: 0 auto; background-color: #070b19; border: 1px solid rgba(251, 191, 36, 0.3); border-radius: 16px; padding: 36px 28px; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.5);">
            ...
            <!-- HEADER BADGE -->
            <div style="border-b: 1px solid #1f2937; padding-bottom: 20px; margin-bottom: 28px; text-center;">
              ...
              <h1 style="color: #ffffff; font-size: 26px; font-weight: 900; tracking-tight: -0.5px; margin: 0;">
                People & Youth
              </h1>
            ...
            <div style="background-color: #030611; border: 1px solid #1f2937; border-radius: 12px; padding: 24px; margin-bottom: 20px;">
              ...
              <div style="font-size: 13px; color: #d1d5db; line-height: 1.6; space-y: 10px;">
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">Dissent Dias:</strong> A platform for essays, ideas, reflections and public discourse.</p>
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">The Renaissance Series:</strong> Our growing research and publication ecosystem spanning multiple disciplines.</p>
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">Knowledge Realms & Knowledge Caves:</strong> Curated intellectual and research environments designed to make knowledge accessible, organized and useful.</p>
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">People & Youth Advisory:</strong> Strategic, policy, institutional, market and organizational advisory initiatives.</p>
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">Leadership & Civic Network:</strong> A growing network of youth ambassadors, coordinators, researchers, consultants, campaigners and institutional contributors.</p>
            ...
            <div style="background-color: #030611; border: 1px solid #1f2937; border-radius: 12px; padding: 24px; margin-bottom: 20px;">
              ...
              <div style="font-size: 13px; color: #d1d5db; line-height: 1.6;">
                <p style="margin: 0 0 10px 0;"><strong style="color: #ffffff;">1. Think independently:</strong> Question assumptions and contribute ideas with intellectual honesty.</p>
                <p style="margin: 0 0 10px 0;"><strong style="color: #ffffff;">2. Work with integrity:</strong> Represent People & Youth responsibly in professional and public settings.</p>
                <p style="margin: 0 0 10px 0;"><strong style="color: #ffffff;">3. Respect evidence:</strong> Distinguish research, opinion, experience and verified information.</p>
                <p style="margin: 0 0 10px 0;"><strong style="color: #ffffff;">4. Collaborate generously:</strong> Recognize that institutional progress is rarely the work of one individual.</p>
                <p style="margin: 0 0 10px 0;"><strong style="color: #ffffff;">5. Take ownership:</strong> Where responsibility is accepted, execution matters as much as intention.</p>
                <p style="margin: 0;"><strong style="color: #ffffff;">6. Protect institutional trust:</strong> Safeguard confidential information, intellectual property, member information and institutional resources.</p>
              </div>
            </div>
            ...
            <div style="background-color: #030611; border: 1px solid rgba(251, 191, 36, 0.2); border-radius: 12px; padding: 24px; margin-bottom: 20px;">
              ...
              <div style="font-size: 13px; color: #e5e7eb; line-height: 1.6;">
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">01 — Review your profile:</strong> Visit your leadership profile at <a href="https://www.peopleandyouth.org/leadership" style="color: #fbbf24; text-decoration: underline;">peopleandyouth.org/leadership</a> and verify your information.</p>
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">02 — Understand your mandate:</strong> Review the responsibilities associated with your designation.</p>
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">03 — Connect with your team:</strong> Coordinate with relevant department heads, partners or colleagues.</p>
                <p style="margin: 0 0 8px 0;"><strong style="color: #fbbf24;">04 — Begin contributing:</strong> Participate in relevant projects, publications, campaigns, research or institutional initiatives.</p>
            ...
            <!-- CARD 6: A NOTE FROM THE FOUNDER'S OFFICE -->
            ...
            <!-- FOOTER SIGN-OFF -->
            <div style="border-t: 1px solid #1f2937; pt-20; text-align: center; font-size: 12px; color: #9ca3af; line-height: 1.6;">
    ...
    return NextResponse.json({ success: true, message: 'Institutional onboarding letter sent successfully' });
  } catch (error: any) {
