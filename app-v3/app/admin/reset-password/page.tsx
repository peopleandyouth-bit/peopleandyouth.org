...
export default function ResetPasswordPage() {
  ...
  async function handleSetPassword(
    ...
    try {
      /*
       * The browser sends ONLY the new password.
       *
       * The server identifies the authenticated user
       * through the Supabase SSR session.
       */
      ...
      if (!res.ok || !data.success) {
        setMessage({
          ...
          text:
            data.error ||
            'Unable to update your password. Please request a new password link.',
        });
      ...
      setMessage({
        type: 'SUCCESS',
        text:
          'Password updated successfully! Redirecting to Command Centre...',
      });
      ...
      <div className="max-w-md w-full bg-[#070b19] border border-amber-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-gray-400">
            Enter your new personal password to secure
            your admin account.
          </p>
